...
@Embeddable
public class TrainingSessionDetailsId implements Serializable {
	/**
	 * 
	 */
	...
	public TrainingSessionDetailsId() {
	}

	public TrainingSessionDetailsId(Long idUser, Long idTrainingsession) {
		super();
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		TrainingSessionDetailsId other = (TrainingSessionDetailsId) obj;
